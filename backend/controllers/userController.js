...
const getPatientFiles = async (req, res) => {
    try {
        ...
        console.error("Error retrieving patient files:", error);
        return res.status(500).json({ success: false, message: "Failed to retrieve files" });
    }
};

// ================= Get Files for a Specific Appointment =================
...
const getProfile = async (req, res) => {
    try {
        // Use req.user from authUser middleware instead of req.body.userId
